    ...
    <header className='flex items-center p-4 shadow-sm bg-slate-800 backdrop-blue-sm'>
        ...
        {/* Menu */}
        {
            ...
            (<nav className='ml-auto mr-10'>
                <ul className="flex items-center gap-5">
                    ...
                    <li>
                        <NavLink to={'/tasks'} className={({ isActive })=> isActive ? 'text-white' : 'text-white/50'}>Tasks</NavLink>
                    </li>
                    <li>
        ...
        {/* Actions */}
        {
            isAuth ? (
                ...
                <Link className='py-2 text-white/50 hover:text-white ml-auto mr-5' to={'auth'}>Sign in</Link>
            )
        }
    </header>
  )
