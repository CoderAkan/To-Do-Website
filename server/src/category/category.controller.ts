...
export class CategoryController {
  ...
  @Get(':type/:id') // http://localhost:3000/api/categories/category/2
  @UseGuards(JwtAuthGuard, AuthorGuard)
  findOne(@Param('id') id: string) {
    return this.categoryService.findOne(+id);
  }

  @Patch(':type/:id') // http://localhost:3000/api/categories/category/2
  @UseGuards(JwtAuthGuard, AuthorGuard)
  ...
  @Delete(':type/:id') // http://localhost:3000/api/categories/category/2
  @UseGuards(JwtAuthGuard, AuthorGuard)
